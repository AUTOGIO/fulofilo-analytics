...
.PHONY: setup-automations automation-refresh-dashboard-data automation-sync-excel-master automation-generate-replenishment-alerts automation-generate-daily-briefing automation-export-reports automation-validate-data-integrity automation-webhook automation-run-daily
